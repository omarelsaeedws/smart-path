          ...
          <div className="container mx-auto px-6 py-4 flex justify-between items-center animate-fade-in-down">
            ...
            <div className="hidden md:flex gap-8 items-center">
              <nav className="flex gap-8">
                <a href="#features" className="text-slate-500 hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-400 font-medium transition-all duration-300 ease-out">
                  المميزات
                </a>
                <a href="#preview" className="text-slate-500 hover:text-sky-500 dark:text-slate-400 dark:hover:text-sky-400 font-medium transition-all duration-300 ease-out">
                  نظرة على المسارات
                </a>
              </nav>
              ...
              <Link to="/login" className="text-slate-600 hover:text-sky-600 dark:text-slate-300 dark:hover:text-sky-400 font-bold px-2 transition-all duration-300 ease-out">
                دخول
              </Link>
              <Link
                to="/register"
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
              <div className="md:col-span-2">
                 <Link to="/" className="flex items-center gap-2 mb-6 group">
                  <img src="/logo.png" alt="SmartPath Logo" className="h-12 object-contain opacity-80 group-hover:opacity-100 block dark:hidden transition-all duration-300 ease-out" />
                  <img src="/logo-white.png" alt="SmartPath Logo" className="h-12 object-contain opacity-80 group-hover:opacity-100 hidden dark:block transition-all duration-300 ease-out" />
                </Link>
              ...
              <div>
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-6">نظرة سريعة</h4>
                <ul className="space-y-4 text-sm font-medium">
                  <li><a href="#features" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-all duration-300 ease-out">المميزات والقدرات</a></li>
                  <li><a href="#preview" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-all duration-300 ease-out">نظرة من الداخل</a></li>
                </ul>
              </div>

              <div>
                <h4 className="text-lg font-bold text-slate-800 dark:text-white mb-6">المستخدمين</h4>
                <ul className="space-y-4 text-sm font-medium">
                  <li><Link to="/login" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-all duration-300 ease-out">تسجيل الدخول</Link></li>
                  <li><Link to="/register" className="text-slate-500 dark:text-slate-400 hover:text-sky-500 dark:hover:text-sky-400 transition-all duration-300 ease-out">انضم إلينا</Link></li>
                </ul>
              </div>
            </div>
            ...
            <div className="border-t border-slate-200/60 dark:border-slate-800/60 pt-8 text-center text-slate-400 dark:text-slate-500 text-sm flex flex-col md:flex-row justify-between items-center font-medium">
              ...
              <div className="flex gap-4 mt-4 md:mt-0">
                 <a href="#" className="hover:text-slate-600 dark:hover:text-slate-400 transition-all duration-300 ease-out">الشروط والأحكام</a>
                 <a href="#" className="hover:text-slate-600 dark:hover:text-slate-400 transition-all duration-300 ease-out">سياسة الخصوصية</a>
              </div>
            </div>
          </div>
        </footer>
