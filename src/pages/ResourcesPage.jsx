  ...
  return (
    <div className="min-h-screen p-4 sm:p-6 lg:p-10" dir="rtl">
      ...
      <div className="max-w-md mx-auto mb-6 relative">
        ...
        />
        <FontAwesomeIcon icon={faSearch} className="absolute right-4 top-1/2 -translate-y-1/2 text-white/40" />
      </div>
          ...
          {filtered.map((tool, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Category badge */}
                {catName && (
                  <span className="relative z-10 inline-flex items-center gap-1.5 px-2 py-0.5 rounded-lg text-xs font-semibold bg-sky-500/15 text-sky-300 border border-sky-500/25 mb-2 w-fit">
