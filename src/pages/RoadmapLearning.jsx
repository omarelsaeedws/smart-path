...
const RoadmapLearning = () => {
  ...
  if (error || !roadmap) {
    return (
      <div
        className="flex flex-col items-center justify-center p-6 h-screen w-full"
        dir="rtl"
      >
        <div className="bg-white/80 dark:bg-slate-800 backdrop-blur-xl border border-slate-200 dark:border-slate-700 p-8 rounded-3xl shadow-2xl max-w-md w-full text-center text-slate-800 dark:text-white">
          ...
          <p className="text-slate-500 dark:text-slate-200 mb-6">
            {error || "لم يتم العثور على المسار"}
          </p>
          <button
  ...
  return (
    <div
      className="p-6 md:p-8 lg:p-10 relative overflow-x-hidden overflow-y-auto w-full min-h-screen"
      dir="rtl"
    >
      {/* Top Header */}
            ...
            <div key={week.id}>
              ...
              <div className="flex items-center gap-4 mb-5">
                <div className="w-12 h-12 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-lg rotate-12">
                  <FontAwesomeIcon
                    icon={faCalendarWeek}
                    className="text-white text-xl -rotate-12"
                  />
                </div>
                <div>
                    ...
                    >
                      ...
                      >
                        <div className="p-6 pt-0 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700">
                          ...
                          {lesson.description && (
                            <div className="py-4">
                              <h5 className="text-sky-600 dark:text-sky-300 font-bold mb-2">
                                ماذا ستتعلم؟
                              </h5>
